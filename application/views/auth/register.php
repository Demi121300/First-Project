            ...
            <div class="card-body p-lg-5 p-0">
                <div class="p-4">
                    <div class="text-center mb-4">
                        <h1 class="h4 text-gray-900">Point of Sale System</h1>
                    ...
                    <div class="form-group">
                        <input value="<?= set_value('nama'); ?>" type="text" name="nama" class="form-control form-control-user" placeholder="Name">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <input value="<?= set_value('no_telp'); ?>" type="text" name="no_telp" class="form-control form-control-user" placeholder="Contact">
                    ...
                    <div class="text-center mt-4">
                        <a class="small" href="<?= base_url('auth') ?>">Have an Account? Login</a>
                    </div>
                    <?= form_close(); ?>
